...
function loadStudentsFromStorage(fallbackStudents) {
...
function normalizeDefaultStudentName(student) {
...
function normalizeStudent(raw) {
    ...
    const maybeStudent = raw;
    if (typeof maybeStudent.id !== "number" ||
    ...
    return {
        ...
        skills: maybeStudent.skills.filter((skill) => typeof skill === "string"),
...
function normalizePhotoUrl(id, photoUrl) {
...
function isProgram(value) {
    return typeof value === "string" && PROGRAM_OPTIONS.includes(value);
}
function isClassYear(value) {
    return typeof value === "string" && CLASS_YEAR_OPTIONS.includes(value);
}
